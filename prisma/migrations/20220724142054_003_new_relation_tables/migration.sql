/*
  ...
  - You are about to drop the column `disciplineTeacherId` on the `tests` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE "tests" DROP COLUMN "disciplineTeacherId",
